   ...
   <div class="container">
      <div class="row">
         <div class="col s12 m12">
            <form action="update-biodata.php" method="POST" enctype="multipart/form-data">
               <div class="card">
                  <div class="card-content" style="margin-bottom: 1px;">
                     <div class="row">
                        <input type="hidden" name="id" value="<?=$id;?>"> 
                        <div class="input-field col s6">
                           <input required value="<?=$row['nama_lengkap']; ?>" id="nama_lengkap" type="text" class="validate" name="nama_lengkap">
                           <label for="nama_lengkap">Nama Depan</label>
                        </div>
                        <div class="input-field col s6">
                           <input required value="<?=$row['nim']; ?>" id="nim" type="text" class="validate" name="nim">
                        ...
                        <div class="col s12">
                           ...
                           <select class="browser-default" name="jurusan" id="jurusan">
                              ...
                              <?php foreach ($jurusan as $as) : ?>
                                 <option value="<?= $as; ?>" <?=$row['jurusan']== $as ? 'selected' :'' ?> ><?= $as; ?></option>
                              <?php endforeach ?>
                           </select>
                        </div>
                     </div>
                     <div class="row">
                        <div class="input-field col s6">
                           <input required value="<?=$row['nama_ayah']; ?>" id="ayah" type="text" class="validate" name="ayah">
                           <label for="ayah">Nama Ayah</label>
                        </div>
                        <div class="row">
                           <div class="input-field col s6">
                              <input required value="<?=$row['nama_ibu']; ?>" id="ibu" type="text" class="validate" name="ibu">
                     ...
                     <div class="row">
                        <div class="input-field col s12">
                           ...
                           <textarea id="alamat" class="materialize-textarea validate" required value="<?=$row['alamat_rumah']; ?>" name="alamat"></textarea>
                        </div>
                     </div>
                     <div class="row">
                        <div class="input-field col s6">
                           <input required value="<?=$row['asal_sekolah']; ?>" id="as_sek" type="text" class="validate" name="as_sek">
                           <label for="as_sek">Asal Sekolah</label>
                        </div>
                     </div>
                     <div class="row">
                        <div class="input-field col s6">
                           <input required value="<?=$row['no_hp']; ?>" id="telepon" type="number" class="validate" name="telepon">
                           <label for="telepon">Nomor Telepon</label>
                        </div>
                     </div>
                     <div class="row" style="margin-bottom: 1px;">
                        <div class="input-field col s6">
                           <input required value="<?=$row['no_hp_ortu']; ?>" id="telepon_ortu" type="number" class="validate" name="telepon_ortu">
